...
function Testimonial() {
    ...
    return (
        <section className="py-20 px-6 md:px-12 bg-[#0c0d0e] text-white">
            <div className="max-w-4xl mx-auto bg-[#141518] rounded-3xl p-8 sm:p-14 text-center shadow-xl relative border border-white/10">

                {/* Avatar */}
                <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden mx-auto mb-6 shadow-md border-2 border-[#30B5AA]">
                    <img
                        src={current.profile}
                        alt={current.name}
                ...
                {/* Name & Role */}
                <h3 className="text-base sm:text-lg font-bold text-[#30B5AA]">{current.name}</h3>
                ...
                <div className="flex justify-center items-center gap-3">
                    <button
                        ...
                        className="w-10 h-10 rounded-full bg-white/10 text-white flex items-center justify-center hover:bg-[#30B5AA] hover:text-black transition shadow-sm"
                    >
